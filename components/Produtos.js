...
const Produtos = () => {
  ...
  const DATA = [
    ...
    },
    {
      ...
      descricao: 'Pastilhas para Garganta Strepsils Mel e Limão é um medicamento analgésico e anti-inflamatório, indicado para aliviar dor de garganta.',
      preco: 'R$ 14,47',
      imagemProduto: require('../assets/img/remedios/5.png'),
    },
    {
      id: 6,
      nomeProduto: 'Losartana Potássica Medley 50mg, caixa com 30 comprimidos revestidos',
      descricao: 'Losartana Potássica é um medicamento para tratar hipertensão (pressão alta) ou doença conhecida como insuficiência cardíaca (enfraquecimento do coração).',
      preco: 'R$ 2,60',
    ...
    },
    {
      ...
      descricao: 'Ibuprofeno 600mg Genérico Prati Donaduzzi 20 Comprimidos combate inflamação, dor e febre, sendo indicado para aliviar sintomas de osteoartrite, artrite reumatoide, reumatismo.',
      preco: 'R$ 8,45',
    ...
    },
    {
      ...
      descricao: 'Loratamed 10mg Cimed (loratadina) é um anti-histamínico utilizado para alívio de sintomas associados a rinite alérgica como coriza, coceira nasal, espirros, ardência.',
      preco: 'R$ 8,50',
    ...
    },
    {
      ...
      descricao: 'Soro Fisiológico é uma solução salina esterilizada utilizada para diversas finalidades como a desidratação, além de usos para limpeza da pele, dos olhos e nariz, queimaduras ou feridas e também para fazer nebulizações.',
      preco: 'R$ 7,99',
    ...
    },
    {
      ...
      descricao: 'O Lacrifilm Colírio é indicado para o tratamento de problemas oftalmológicos como ressecamento nos olhos, ardência, coceira, exposição ao sol, vento e mar.',
      preco: 'R$ 28,99',
    ...
    },
    {
      ...
      descricao: 'Lacto-Purga (bisacodil) é um laxante de ação local indicado para tratamento da prisão de ventre.',
      preco: 'R$ 5,79',
    ...
    },
    {
      ...
      descricao: 'Simeticona Gotas 75mg/ml Genérico Cimed com 15ml é indicado para tratar pacientes com excesso de gases no aparelho digestivo e aliviar sintomas como desconforto.',
      preco: 'R$ 4,99',
    ...
    },
    {
      ...
      descricao: 'Relaxante Muscular Miorrelax 10 Comprimidos é utilizado para aliviar dores associadas a contraturas musculares, incluindo a dor de cabeça tensional.',
      preco: 'R$ 4,99',
    ...
    },
    {
      ...
      descricao: 'Glifage 850mg Merck S/A 30 Comprimidos é indicado para tratar a diabetes tipo 2, associado a uma dieta alimentar.',
      preco: 'R$ 29,99',
      imagemProduto: require('../assets/img/remedios/14.png'),
    },
    {
      id: 15,
      nomeProduto: 'Insulina Tresiba Flextouch Novo Nordisk 1 Caneta Descartável 3ml',
      descricao: 'Insulina Tresiba Flextouch Novo Nordisk 1 Caneta Descartável 3ml é indicada para tratar a diabetes mellitus, reduzindo o nível de açúcar no sangue.',
      preco: 'R$ 148,00',
    ...
    },
    {
      ...
      descricao: 'Fralda Descartável Pampers é um produto de higiene íntima usado por bebês e crianças.',
      preco: 'R$ 36,74',
    ...
    },
    {
      ...
      descricao: 'Lenços Umedecidos Huggies Puro e Natural limpa de forma segura e ajuda a prevenir assaduras.',
      preco: 'R$ 15,90',
      imagemProduto: require('../assets/img/remedios/17.png'),
    },
    {
      id: 18,
      nomeProduto: 'Gel de Limpeza Facial La Roche-Posay Effaclar Concentrado 300g',
      descricao: 'Gel de Limpeza Facial La Roche-Posay Effaclar limpa profundamente a pele, reduzindo a oleosidade e lesões acneicas.',
      preco: 'R$ 79,90',
    ...
    },
    {
      ...
      descricao: 'Hidratante Facial Neutrogena combina uma exclusiva textura ultraleve gel não oleosa, de rápida absorção e refrescante.',
      preco: 'R$ 87,69',
    ...
    },
    {
      ...
      descricao: 'Dimorf 10mg (sulfato de morfina pentaidratado) atua sobre sistema nervoso central e outros órgãos do corpo proporcionando alívio para dores intensas e crônicas.',
      preco: 'R$ 51,59',
